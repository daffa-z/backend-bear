...
export const saveSurat = async(req, res) => {
    ...
    const tujuanSurat = req.body.tujuanSurat;
    ...
    file.mv(`./public/images/${fileName}`, async(err)=>{
        file2.mv(`./public/images/${fileName2}`, async(err)=>{
            ...
            try {
                await SuratKeluar.create({perihal: perihal,
...
export const updateSurat = async(req, res) => {
    ...
    try {
        await SuratKeluar.update({perihal: perihal,
            tanggalSurat: tanggalSurat,
            tanggalKirim: tanggalKirim,
            tujuanSurat: tujuanSurat,
            nomorSurat: nomorSurat,
...
export const deleteSurat = async(req, res) => {
    ...
    try {
        const filepath = `./public/images/${surat.surat}`;
        fs.unlinkSync(filepath);
        const filepath2 = `./public/images/${surat.bukti}`;
        fs.unlinkSync(filepath2);
        await surat.destroy({
            where:{
                id : req.params.id
